package cg.dieudonne.nieme.travelmantics.activities;
...
public class DealActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.deal = deal;
        et_title.setText(deal.getTitle());
        et_description.setText(deal.getDescription());
        et_price.setText(deal.getPrice());
        showImage(deal.getImageUrl());
        Button btnImage = findViewById(R.id.btn_select_image);
    ...
    private void saveDeal() {
        deal.setTitle(et_title.getText().toString());
        deal.setDescription(et_description.getText().toString());
        deal.setPrice(et_price.getText().toString());
        if(deal.getId()==null) {
    ...
    private void enableEditTexts(boolean isEnabled) {
        et_title.setEnabled(isEnabled);
        et_description.setEnabled(isEnabled);
        et_price.setEnabled(isEnabled);
    }
